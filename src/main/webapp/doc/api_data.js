define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/listRoleByAuthid",
    "title": "根据权限id查询角色 传空则返回所有",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/listRoleByAuthid"
      }
    ],
    "name": "listRoleByAuthid",
    "group": "AuthorityController",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    "type": "post",
    "url": "/api/addDataAuth",
    "title": "添加新的数据权限 或 修改权限 有传l_authid 则为修改",
    "version": "1.0.0",
    "sampleRequest": [
      {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/job"
      }
    ],
    "name": "add_job",
    "group": "JobController",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "frequency",
            "description": "<p>频率：0为一次性，1为每天，2为每周，3位每月</p>"
          },
          {
            "group": "Parameter",
            "type": "int[]",
            "optional": false,
            "field": "whichDay",
            "description": "<p>频率为周和月时，数组中保存一周中或一个月中哪几天触发</p>"
          },
          {
            "group": "Parameter",
            "type": "LocalTime",
    ...
    "filename": "../../java/com/quantchi/quartz/controller/JobController.java",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/deleteJob"
      }
    ],
    "name": "deleteJob",
    "group": "JobController",
  ...
  {
    "type": "post",
    "url": "/api/job/exchangeState",
    "title": "切换状态接口",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/job/exchangeState"
      }
    ],
    "name": "exchangeState",
    "group": "JobController",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/execJob"
      }
    ],
    "name": "execJob",
    "group": "JobController",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>任务状态  0 未激活 1 激活</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/job/updateJob"
      }
    ],
    "name": "updateJob",
    "group": "JobController",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "job.datasourceName",
            "description": "<p>数据源名称</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/api/physicalLineage/downstream",
    "title": "查询downstream",
    "permission": [
      {
        "name": "none"
    ...
    "version": "1.0.0",
    "name": "physical_Lineage_downstream",
    "group": "LineageController",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "fieldName",
            "description": "<p>字段名(db.table.field)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "data.nodes.phsicalFieldId",
  ...
  {
    "type": "get",
    "url": "/api/physicalLineage/upstream",
    "title": "查询upstream",
    "permission": [
      {
        "name": "none"
    ...
    "version": "1.0.0",
    "name": "physical_Lineage_upstream",
    "group": "LineageController",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/login"
      }
    ],
    "name": "login",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "msg",
            "description": "<p>登录成功或者错误信息</p>"
          }
        ]
      }
    },
    "filename": "../../java/com/quantchi/authority/controller/LoginController.java",
    "groupTitle": "LoginController"
  },
  {
    "type": "post",
    "url": "/api/schemaDiff/deleteJob",
    "title": "删除元数据比对任务",
    "version": "1.0.0",
    "name": "deleteJob",
    "group": "MetaDataDsDiffController______",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "data",
            "description": "<blockquote> <p>=1 成功</p> </blockquote>"
          }
        ]
      }
    },
    "filename": "../../java/com/quantchi/metadatamgr/controller/MetaDataDsDiffController.java",
    "groupTitle": "MetaDataDsDiffController______"
  },
  {
    "type": "get",
    "url": "/api/schemaDiff/getAllJob",
    "title": "获取查询元数据比对任务",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/schemaDiff/getAllJob"
      }
    ],
    "name": "getAllJob",
    "group": "MetaDataDsDiffController______",
  ...
  {
    "type": "post",
    "url": "/api/schemaDiff/getAllVersion",
    "title": "获取所有的版本",
    "version": "1.0.0",
  ...
  {
    "type": "get",
    "url": "/api/schemaDiff/insertDiffJob",
    "title": "插入对比Job",
    "version": "1.0.0",
    "name": "insertDiffJob",
    "group": "MetaDataDsDiffController______",
  ...
  {
    "type": "get",
    "url": "/api/schemaDiffByJob/",
    "title": "不同数据源比对详情",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/schemaDiffByJob"
      }
    ],
    "name": "schemaDiff_detail",
    "group": "MetaDataDsDiffController______",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "operation",
            "description": "<p>筛选operation (ADD, DEL, MOD)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "data",
            "description": "<p>和&quot;同一个数据源比对详情API&quot;相同</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/schemaDiff"
      }
    ],
    "name": "schemaDiff_version",
    "group": "MetaDataDsDiffController______",
    "parameter": {
      "fields": {
        "Parameter": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "int",
            "optional": true,
            "field": "data.sourceTableAmount",
            "description": "<p>source中表的总计数量</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.targetTableAmount",
            "description": ""
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.sourceFieldAmount",
            "description": "<p>source中字段的总计数量</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.targetFieldAmount",
            "description": ""
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.tableAdditionsAmount",
            "description": "<p>添加表数</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.tableDeletionsAmount",
            "description": ""
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "int",
            "optional": true,
            "field": "data.fieldAdditionsAmount",
            "description": "<p>添加字段数</p>"
          },
          {
            "group": "Success 200",
            "type": "int",
            "optional": true,
            "field": "data.fieldDeletionsAmount",
            "description": ""
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "List",
            "optional": true,
            "field": "data.modifications",
            "description": "<p>具体修改的字段</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.modifications.fieldName",
            "description": ""
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.modifications.operation",
            "description": "<p>ADD or DEL or MOD (添加，删除，修改)</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.modifications.desc",
            "description": ""
          }
        ]
      }
  ...
  {
    "type": "post",
    "url": "/api/updateVerInfo",
    "title": "元数据版本更新",
    "description": "<p>某个版本定版</p>",
    "version": "1.0.0",
    "name": "updateVerInfo",
    "group": "MetaDataDsDiffController",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "filename": "../../java/com/quantchi/metadatamgr/controller/MetaDataDsDiffController.java",
    "groupTitle": "MetaDataDsDiffController"
  },
  {
    "type": "get",
    "url": "/api/extractLog",
    ...
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/extractLog/"
      }
    ],
    "name": "extractLog",
    "group": "MetaDataDsExtractController",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "log",
            "description": "<p>返回日志内容</p>"
          }
        ]
      }
    },
    "filename": "../../java/com/quantchi/quartz/controller/JobExtractHisController.java",
    "groupTitle": "MetaDataDsExtractController"
  },
  {
    "type": "get",
    "url": "/api/extractorJob",
    "title": "获取查询元数据抽取任务列表",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/extractorJob/"
      }
    ],
    "name": "extractorJob",
    "group": "MetaDataDsExtractController",
  ...
  {
    "type": "post",
    "url": "/api/extractorJob/del",
    "title": "删除元数据抽取任务历史",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/extractorJob/del"
      }
    ],
    "name": "extractorJob_del",
    "group": "MetaDataDsExtractController",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "jobHisIdList.jobHisId",
            "description": "<p>抽取日志历史id</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "post",
    "url": "/api/metadata/check/searchBusin",
    "title": "获取业务规则",
    "version": "1.0.0",
    "name": "searchBusin",
    "group": "MetaDataMgrCheckApiController",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "businfilter",
            "description": "<p>过滤条件 id 或者规则名字</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "checkstatus",
            "description": "<p>状态 0 未审核 1 审核通过 2 打回</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "ruletypefilter",
            "description": "<p>规则类过滤</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Request-example:",
          "content": "{\"page\":1,\"page_size\":100,\"businfilter\":\"测试\",\"checksystem\":\"UF20\",\"checkstatus\":\"0\",\"ruletypefilter\":\"1_2\"}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "data.rulesecondtype",
            "description": "<p>规则小类</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.rulefirsttype",
            "description": "<p>规则大类</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.checksystem",
            "description": "<p>业务系统</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "optional": true,
            "field": "data.rulename",
            "description": "<p>规则名字</p>"
          },
          {
            "group": "Success 200",
            "type": "list",
            "optional": true,
            "field": "data.techruleids",
            "description": "<p>技术规则id</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.businid",
            "description": "<p>业务规则id</p>"
          }
        ]
      }
    },
    "filename": "../../java/com/quantchi/metadatamgr/controller/MetaDataMgrCheckApiController.java",
    "groupTitle": "MetaDataMgrCheckApiController"
  },
  {
    "type": "post",
    "url": "/api/metadata/check/searchTech",
    "title": "获取技术规则",
    "version": "1.0.0",
    "name": "searchTech",
    "group": "MetaDataMgrCheckApiController",
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request-example:",
          "content": "{\"page\":1,\"page_size\":100,\"techfilter\":\"测试\",\"checksystem\":\"UF20\",\"checkstatus\":\"0\",\"ruletypefilter\":\"1_2\"}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "data.sourcedata",
            "description": "<p>业务数据库</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": true,
            "field": "data.sourdecol",
            "description": "<p>数据字段</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "type": "String",
            "optional": true,
            "field": "data.rulesqltext",
            "description": "<p>检验sql语句</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/api/getBusinSystemList",
    "title": "获取业务系统列表",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/getBusinSystemList"
      }
    ],
    "name": "getBusinSystemList",
    "group": "MetaDataTreeMenuController",
    "success": {
      "fields": {
        "Success 200": [
          {
    ...
    "filename": "../../java/com/quantchi/metadatamgr/controller/MetaDataTreeMenuController.java",
    "groupTitle": "MetaDataTreeMenuController"
  },
  {
    "type": "get",
    "url": "/api/getRuleClassTree",
    "title": "获取规则类树",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/getRuleClassTree"
      }
    ],
    "name": "getRuleClassTree",
    "group": "MetaDataTreeMenuController",
    "success": {
      "fields": {
        "Success 200": [
  ...
  {
    "type": "get",
    "url": "/api/metadataTree",
    "title": "获取元数据树形列表",
    "description": "<p>不带数据源,则返回数据源上层,带数据源参数，则返回表列表，带表参数，则返回对应的字段</p>",
    "version": "1.0.0",
    "sampleRequest": [
      {
        "url": "http://192.168.2.61:8082/quantchiAPI/api/metadataTree/"
      }
    ],
    "name": "metadataTree_menu",
    "group": "MetaDataTreeMenuController",
    "parameter": {
      "fields": {
        "Parameter": [
