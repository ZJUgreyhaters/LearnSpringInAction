...
public class ExportUtil {
     ...
     * @return
     */
    public  final static String exportRelationExcel(HttpServletResponse response, String fileName, String title, String[] titleArray, List<? extends Object> listContent) {
...
//                        va="";
                    ...
                    // 导出的时候按照field的顺序导出的，这里打个补丁
                    int c = j - 1;
                    if (v.getName().equals("commission")) {
                        c = 9;
                    }
                    sheet.addCell(new Label(c, i,va.toString().replaceAll("9999999999.(00)+", "-").replaceAll("9.999999999E9", "-"),wcf_center));
                    j++;
                }
                i++;
            }
