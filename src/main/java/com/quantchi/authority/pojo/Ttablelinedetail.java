...
public class Ttablelinedetail {

  private long l_Linedetailid;
  private String c_Tablename;
  private String c_Column;
  private String c_Fiterdesc;
  ...
  public void setL_Linedetailid(long l_Linedetailid) {
    this.l_Linedetailid = l_Linedetailid;
  }
  ...
  public String getC_fiterdesc() {
    return c_Fiterdesc;
  }

  public void setC_Fiterdesc(String c_Fiterdesc) {
    this.c_Fiterdesc = c_Fiterdesc;
  }


  public String getC_fiter() {
    return c_Fiter;
  }

  public void setC_Fiter(String c_Fiter) {
    this.c_Fiter = c_Fiter;
  }
