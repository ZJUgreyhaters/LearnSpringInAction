...
public class JobHelper {
    ...
    public static JobInfo buildJobInfo(JobDetail jobDetail){
        JobInfo jobInfo = new JobInfo();
        jobInfo.setStoreDurably(jobDetail.isDurable());
        ...
        jobDetail.getJobDataMap().entrySet().forEach(i->jobInfo.getJobParams().put(i.getKey(),i.getValue()));
        return jobInfo;
    }
